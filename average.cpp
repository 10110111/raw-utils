...
void printAverageColor(LibRaw& libRaw, const ushort (*img)[4], const int w, const int h,
...
int main(int argc, char** argv)
{
    ...
    printAverageColor(libRaw,libRaw.imgdata.image,sizes.iwidth,sizes.iheight,libRaw.imgdata.color,rgbCoefs);
}
